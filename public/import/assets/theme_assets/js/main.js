        ...
        fileReader.addEventListener("load", function (event) {
          ...
          let fileName = `
                      <li id="this_li">
                        ...
                        <a href="#" class="btn-delete" onclick="document.getElementById('this_li').remove();document.getElementById('upload-1').value= null;"><i class="la la-trash"></i></a>
                      </li>
                    `;
...
//!remove li tag on click reset

const resetButton = document.querySelector('button[type="reset"]');
resetButton.addEventListener('click', removeLiTag);
